...
@section('subtitle', 'Ingresa tus datos registrarte')
                    ...
                    <form role="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            <div class="input-group input-group-alternative">
                                ...
                                <input class="form-control" placeholder="Contrasena" type="password" name="password" 
                        ...
                        <div class="form-group">
                            <div class="input-group input-group-alternative">
                                ...
                                <input class="form-control" placeholder="Confirmar contrasena" type="password" 
